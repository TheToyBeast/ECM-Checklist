jQuery(document).ready(function($) {
    ...
    var rowHtml = '' +
			'<div class="product-row">' +
				...
				'<input type="number" name="product_number[]" value=""><br>' +
				'<label>Name:</label><br>' +
				'<input type="text" name="product_name[]" value=""><br>' +
				'<label>Product Link:</label><br>' +
				'<input type="text" name="product_link[]" value=""><br>' +
				'</div>' +
				'<div class="row3">' +
				'<label>Short Description:</label><br>' +
				'<input type="text" name="product_description[]" value=""><br>' +
				'<label>Image:</label><br>' +
				'<input id="upload_image_button" type="button" class="button upload_image_button" value="Add Image" />' +
				'<input type="hidden" name="product_image[]" value=""><br>' +
				'<img class="product_image_display" src="" style="max-width: 100px; max-height: 100px;"/><br>' +
				'</div>' +
